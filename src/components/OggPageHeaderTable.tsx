...
export const OggPageHeaderTable = ({ page, showHex }: OggPageTableProps) => (
  <table className="ogg-page-table byte-table">
    <tbody>
      ...
      {showHex && (
        <tr>
          <td className="byte-table__hex-cell byte-table__cell-style-1">{page.getCapturePatternHex(0)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-1">{page.getCapturePatternHex(1)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-1">{page.getCapturePatternHex(2)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-1">{page.getCapturePatternHex(3)}</td>
        </tr>
      )}
      <tr>
        <td className="byte-table__interpretation-cell byte-table__cell-style-1">{page.capturePattern[0]}</td>
        <td className="byte-table__interpretation-cell byte-table__cell-style-1">{page.capturePattern[1]}</td>
        <td className="byte-table__interpretation-cell byte-table__cell-style-1">{page.capturePattern[2]}</td>
        <td className="byte-table__interpretation-cell byte-table__cell-style-1">{page.capturePattern[3]}</td>
      </tr>
      ...
      <tr>
        ...
        <td className="byte-table__header-cell byte-table__cell-style-3 byte-table__starts-mid-table">Header Type</td>
        <td className="byte-table__header-cell byte-table__cell-style-4 byte-table__starts-mid-table" colSpan={2}></td>
      </tr>
      {showHex && (
        <tr>
          ...
          <td className="byte-table__hex-cell byte-table__cell-style-4">{page.getGranulePositionHex(1)}</td>
        </tr>
      )}
      <tr>
      ...
      {showHex && (
        <tr>
          <td className="byte-table__hex-cell byte-table__cell-style-4">{page.getGranulePositionHex(2)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-4">{page.getGranulePositionHex(3)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-4">{page.getGranulePositionHex(4)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-4">{page.getGranulePositionHex(5)}</td>
        </tr>
      )}
      <tr>
      ...
      <tr>
        ...
        <td className="byte-table__header-cell byte-table__cell-style-5 byte-table__starts-mid-table" colSpan={2}>
          Bitstream Serial Number
        </td>
      </tr>
      {showHex && (
        <tr>
          <td className="byte-table__hex-cell byte-table__cell-style-4">{page.getGranulePositionHex(6)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-4">{page.getGranulePositionHex(7)}</td>
          ...
          <td className="byte-table__hex-cell byte-table__cell-style-5">{page.getBitstreamSerialNumberHex(1)}</td>
        </tr>
      )}
      <tr>
      ...
      <tr>
        ...
        <td className="byte-table__header-cell byte-table__cell-style-6 byte-table__starts-mid-table" colSpan={2}>
          Page Sequence Number
        </td>
      </tr>
      {showHex && (
        <tr>
          <td className="byte-table__hex-cell byte-table__cell-style-5">{page.getBitstreamSerialNumberHex(2)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-5">{page.getBitstreamSerialNumberHex(3)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-6 byte-table__starts-mid-table">
            {page.getPageSequenceNumberHex(0)}
          </td>
          <td className="byte-table__hex-cell byte-table__cell-style-6">{page.getPageSequenceNumberHex(1)}</td>
        </tr>
      )}
      <tr>
        <td className="byte-table__interpretation-cell byte-table__cell-style-5" colSpan={2}></td>
        <td
      ...
      <tr>
        ...
        <td className="byte-table__header-cell byte-table__cell-style-7 byte-table__starts-mid-table" colSpan={2}>
          CRC Checksum
        </td>
      </tr>
      {showHex && (
        <tr>
          <td className="byte-table__hex-cell byte-table__cell-style-6">{page.getPageSequenceNumberHex(2)}</td>
          <td className="byte-table__hex-cell byte-table__cell-style-6">{page.getPageSequenceNumberHex(3)}</td>
      ...
      <tr>
        <td className="byte-table__interpretation-cell byte-table__cell-style-6" colSpan={2}></td>
        <td
      ...
      <tr>
        ...
        <td className="byte-table__header-cell byte-table__cell-style-8 byte-table__starts-mid-table">Page Segments</td>
